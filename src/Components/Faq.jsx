...
const faqData = [
  ...
  },
  {
    ...
    "answer": "We are so happy you are choosing to use GigHunt to assist in your job search! Please note that GigHunt does not operate as a recruiting service, but rather functions as a job search engine. \n\n To apply for jobs on GigHunt, first navigate to our homepage. Here you will find a search bar, you can enter your desired keywords related to the type of job you’re looking for, a company name, or industry you would like to work in.Once you have your search set up, click  view  details."
  },
  {
    "id": 2023,
    "question": "Improving Your GigHunt Job Searches (Tips and Help)",
    "answer": " Employers post hundreds of new jobs every month. Sifting through so many jobs can be hard, frustrating, and sometimes stressful. Our goal in this article is to help you maximize your job search and connect you to the right employers.To do that use keyword combinations in the search bar"
  }
]
  console.log(faqData)
